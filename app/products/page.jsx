...
const page = () => {
    return (
        <section className='bg2-dark h-[100svh] max-md:min-h-[100svh] max-md:h-fit pt-[10svh] flex max-md:flex-col justify-center items-center gap-10'>
            <a href='/products/cattle' className=' p-2 rounded-2xl bg-green-100/80 hover:scale-[1.02] transition-all duration-500 ease-in-out flex flex-col items-center text-justify gap-4 cursor-pointer w-fit border-2 border-green-500'>
            ...
            <a href='/products/swine' className=' p-2 rounded-2xl bg-green-100/80 hover:scale-[1.02] transition-all duration-500 ease-in-out flex flex-col items-center text-justify gap-4 cursor-pointer w-fit border-2 border-green-500'>
