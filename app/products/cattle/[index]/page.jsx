...
const page = () => {
    ...
    return (
        <section className='bg2 h-[100svh] pt-[10svh] flex max-md:flex-col justify-center items-center gap-20 max-md:gap-10 pl-12 max-md:px-0'>
            <motion.div className="relative w-fit h-fit max-md:w-2/5 max-md:mt-6"
            ...
            <motion.div className="w-full pr-12 py-12 max-md:py-6 max-md:px-6 h-full overflow-y-auto flex flex-col gap-6 max-md:text-center max-md:items-center"
