...
export default function Home() {
  return (
    <main>
      <section className="bg h-[90svh] pl-16 max-md:px-6 max-md:pb-8 max-md:justify-center flex max-md:flex-col items-center gap-16 2xl:gap-40">

        <div className=" w-1/2 max-md:w-full flex flex-col gap-5">
          <h1 className=" font-semibold text-3xl">V S Agrotech</h1>
          ...
          <div className=" flex gap-8 font-medium mt-4">
